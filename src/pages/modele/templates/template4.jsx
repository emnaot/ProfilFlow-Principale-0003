...
const CVTemplate4 = ({ cvData }) => {
  ...
  return (
    <Container maxWidth="lg">
      <StyledPaper>
        <Header>
          <Avatar alt={cvData["Nom et Prénom"]} src="/static/images/avatar/1.jpg" sx={{ width: 100, height: 100, margin: 'auto', border: '3px solid #1abc9c' }} />
          <Box mt={2}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Section>
              ...
              <List>
                <ListItem>
                  <ListItemText primary={cvData["Vie Associative"]} />
                </ListItem>
              </List>
            </Section>
          </Grid>
